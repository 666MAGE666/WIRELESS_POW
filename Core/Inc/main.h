...
#define FAULT1_LED_Pin GPIO_PIN_12
#define FAULT1_LED_GPIO_Port GPIOD
#define READY_LED_Pin GPIO_PIN_13
#define READY_LED_GPIO_Port GPIOD
#define RESET_LED_Pin GPIO_PIN_14
#define RESET_LED_GPIO_Port GPIOD
#define FAULT4_LED_Pin GPIO_PIN_15
#define FAULT4_LED_GPIO_Port GPIOD
#define READY_Pin GPIO_PIN_7
#define READY_GPIO_Port GPIOC
#define RESET_Pin GPIO_PIN_5
#define RESET_GPIO_Port GPIOB
#define FAULT4_Pin GPIO_PIN_9
#define FAULT4_GPIO_Port GPIOB
#define FAULT3_Pin GPIO_PIN_1
#define FAULT3_GPIO_Port GPIOE
